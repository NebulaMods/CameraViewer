...
partial class MainScreen
{
    ...
    private void InitializeComponent()
    {
        ...
        RstpFeed = new LibVLCSharp.WinForms.VideoView();
        ...
        ((System.ComponentModel.ISupportInitialize)RstpFeed).BeginInit();
        ...
        // RstpFeed
        // 
        RstpFeed.BackColor = Color.Black;
        RstpFeed.Dock = DockStyle.Fill;
        RstpFeed.Location = new Point(0, 31);
        RstpFeed.MediaPlayer = null;
        RstpFeed.Name = "RstpFeed";
        RstpFeed.Size = new Size(660, 383);
        RstpFeed.TabIndex = 0;
        RstpFeed.Text = "RstpFeed";
        // 
        // ToolBar
        // 
        ...
        Load += Main_Load;
        Shown += Main_Shown;
        ((System.ComponentModel.ISupportInitialize)RstpFeed).EndInit();
    ...
    private LibVLCSharp.WinForms.VideoView RstpFeed;
